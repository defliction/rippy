...
<div class="card w-96 bg-base-200 shadow border">
    ...
    <div class="card-body px-6 pb-4 text-center ">
        ...
        <input bind:value={$pmtAmt} class="w-48 justify-end text-right pr-2 text-xl border border-4 border-accent hover:border-accent from-[#20BF55] to-[#01BAEF] pt-1 rounded-lg text-center " placeholder="Enter USDC amount" />
    </div>
    </div>
