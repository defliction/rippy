...
<div class="grid grid-flow-row justify-center">
    ...
    <h1 class="sm:pt-3 pt-1 font-greycliffbold text-4xl text-center text-transparent bg-clip-text bg-gradient-to-br from-[#20BF55] to-[#01BAEF]">
        {$storeName}</h1>
        <div class="pt-4 ">
            <svg class="inline-block align-top h-10 w-10" xmlns="http://www.w3.org/2000/svg" data-name="86977684-12db-4850-8f30-233a7c267d11" viewBox="0 0 2000 2000">
            ...
            <input  bind:this={keyboardRef} bind:value={$pmtAmt} class="js-virtual-keyboard text-2xl border border-2 border-accent hover:border-accent from-[#20BF55] to-[#01BAEF] pt-1 rounded-lg text-center " data-kioskboard-type="numpad" data-kioskboard-placement="bottom" placeholder="Enter USDC amount" />
