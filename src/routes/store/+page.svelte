...
<div class="grid grid-flow-row justify-center">
    ...
    <h1 class="sm:pt-3 pt-1 font-greycliffbold text-4xl text-center text-transparent bg-clip-text bg-gradient-to-br from-[#20BF55] to-[#01BAEF]">
        ...
        <div class="pt-4 ">
            ...
            <input  bind:this={keyboardRef} bind:value={$pmtAmt} class="js-virtual-keyboard text-2xl border border-2 border-[#0D7071] pt-1 rounded-full text-center " data-kioskboard-type="numpad" data-kioskboard-placement="bottom" placeholder="Enter USDC amount" />
